      ...
      <div className="max-w-3xl mx-auto bg-white rounded-3xl shadow-sm border border-slate-100 p-8 md:p-12 space-y-8">
        ...
        <div className="space-y-6 text-slate-700 leading-relaxed">
          <div className="space-y-3">
            ...
            <p>
              &quot;JadHor OS&quot; เป็นเพียง <strong>ผู้ให้บริการแพลตฟอร์มซอฟต์แวร์ (Software as a Service)</strong> เพื่ออำนวยความสะดวกในการจัดการบิลและการชำระเงินเท่านั้น เราไม่ใช่คู่สัญญาเช่า ไม่ใช่ตัวแทนรับชำระเงิน และไม่มีส่วนได้ส่วนเสียในค่าเช่าของคุณ
            </p>
          </div>
