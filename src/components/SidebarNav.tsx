    ...
    <nav className="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
      ...
      {role === "OWNER" && (
        <>
          ...
          <Link href="/dashboard/deposits" className={`flex items-center px-4 py-3 rounded-xl transition-all group font-medium ${pathname.startsWith("/dashboard/deposits") ? "bg-orange-50 text-orange-700" : "text-slate-600 hover:bg-orange-50 hover:text-orange-700"}`}>
            <div className={`w-8 h-8 rounded-lg flex items-center justify-center mr-3 group-hover:scale-105 transition-transform ${pathname.startsWith("/dashboard/deposits") ? "bg-orange-100 text-orange-600" : "bg-orange-50 text-orange-500 group-hover:bg-orange-100"}`}>
      ...
      {role === "TENANT" && (
        <>
          ...
          <Link href="/dashboard/my-meters/report" className={`flex items-center px-4 py-3 rounded-xl transition-all group font-medium ${pathname.startsWith("/dashboard/my-meters") ? "bg-amber-50 text-amber-700" : "text-slate-600 hover:bg-amber-50 hover:text-amber-700"}`}>
            <div className={`w-8 h-8 rounded-lg flex items-center justify-center mr-3 group-hover:scale-105 transition-transform ${pathname.startsWith("/dashboard/my-meters") ? "bg-amber-100 text-amber-600" : "bg-amber-50 text-amber-500 group-hover:bg-amber-100"}`}>
