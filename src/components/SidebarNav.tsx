    ...
    <nav className="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
      ...
      {role === "OWNER" && (
        <>
          ...
          <Link href="/dashboard/saas-billing" className={`flex items-center px-4 py-3 rounded-xl transition-all group font-medium ${pathname.startsWith("/dashboard/saas-billing") ? "bg-rose-50 text-rose-700" : "text-slate-600 hover:bg-rose-50 hover:text-rose-700"}`}>
            <div className={`w-8 h-8 rounded-lg flex items-center justify-center mr-3 group-hover:scale-105 transition-transform ${pathname.startsWith("/dashboard/saas-billing") ? "bg-rose-100 text-rose-600" : "bg-rose-50 text-rose-500 group-hover:bg-rose-100"}`}>
